...
require Rails.root.join('app', 'gen', 'api', 'pancake', 'pancake_pb')
require Rails.root.join('app', 'gen', 'api', 'pancake', 'pancake_services_pb')
...
class Bakery
  ...
  def self.report
    res = stub.report(Pancake::ReportRequest.new())
  ...
  def self.stub
    Pancake::PancakeBakerService::Stub.new(
      config_dsn,
